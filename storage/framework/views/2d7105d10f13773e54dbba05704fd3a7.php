...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-blue-600"><?php echo e($stats['new']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-amber-600"><?php echo e($stats['unread']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-green-600"><?php echo e($stats['read']); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-4 mb-6">
            <form method="GET" action="<?php echo e(route('contactadmin')); ?>">
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div x-data="{ open: false, selected: '<?php echo e(request('status') ?: 'all'); ?>' }" class="min-w-[180px] relative">
            ...
            'all': 'Semua Status'
                    ...
                    <!-- Reset Button -->
                    <a href="<?php echo e(route('contactadmin')); ?>" class="px-6 py-2.5 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition font-semibold text-sm">
                        Reset
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition <?php echo e(!$inquiry->isRead() ? 'bg-blue-50/30' : ''); ?>" data-id="<?php echo e($inquiry->id); ?>">
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-slate-700 font-medium">
                                <?php echo e(($inquiries->currentPage() - 1) * $inquiries->perPage() + $index + 1); ?>

                            </td>
                            <td class="px-4 py-4">
                                <div class="flex items-start">
                                    <?php if(!$inquiry->isRead()): ?>
                                    <span class="inline-block w-2 h-2 bg-blue-600 rounded-full mr-2 mt-2 animate-pulse"></span>
                                    <?php endif; ?>
                                    <div>
                                        <div class="text-sm font-semibold text-slate-900"><?php echo e($inquiry->full_name); ?></div>
                                        <?php if($inquiry->company_name): ?>
                                        <div class="text-xs text-slate-600"><?php echo e($inquiry->company_name); ?></div>
                                        <?php endif; ?>
                                        <div class="text-xs text-slate-500"><?php echo e($inquiry->email); ?></div>
                                        <div class="text-xs text-slate-500"><?php echo e($inquiry->phone_number); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-4">
                                <div class="text-sm font-semibold text-slate-900 mb-1"><?php echo e($inquiry->subject); ?></div>
                                <p class="text-sm text-slate-700 line-clamp-2"><?php echo e($inquiry->message); ?></p>
                                <?php if($inquiry->admin_notes): ?>
                                <div class="mt-2 p-2 bg-amber-50 rounded border border-amber-200">
                                    <p class="text-xs text-amber-800"><strong>Admin Notes:</strong> <?php echo e($inquiry->admin_notes); ?></p>
                                </div>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($inquiry->getStatusBadgeClass()); ?>">
                                    <span class="mr-1"><?php echo $inquiry->getStatusIcon(); ?></span>
                                    <?php echo e($inquiry->getStatusLabel()); ?>

                                </span>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="text-sm text-slate-900"><?php echo e($inquiry->created_at->format('d M Y')); ?></div>
                                <div class="text-xs text-slate-500"><?php echo e($inquiry->created_at->format('H:i')); ?></div>
                                <div class="text-xs text-slate-400 mt-0.5"><?php echo e($inquiry->created_at->diffForHumans()); ?></div>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1">
                                    <!-- Detail Button -->
                                    <button onclick="openDetailModal(<?php echo e(Js::from($inquiry)); ?>)"
                                    ...
                                    <!-- Delete Button -->
                                    <button onclick="openDeleteModal(<?php echo e(Js::from($inquiry)); ?>)"
            ...
            <div class="bg-white px-6 py-4 border-t border-slate-200">
                ...
                <?php echo e($inquiries->withQueryString()->links('pagination.custom')); ?>
...
<?php echo $__env->make('layouts.adminmain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\indo_drilling_school\resources\views/contactadmin.blade.php ENDPATH**/ ?>