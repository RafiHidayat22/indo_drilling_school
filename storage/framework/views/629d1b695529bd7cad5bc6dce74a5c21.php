...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['ongoing']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-cyan-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['completed']); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-4 mb-6">
            <form method="GET" action="<?php echo e(route('admin.projects.index')); ?>" class="flex flex-wrap items-center gap-4">
                <div class="flex-1 min-w-[250px]">
                    <div class="relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari project..." class="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                ...
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="px-4 py-2.5 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition text-sm font-medium">
                    Reset
                </a>
                <?php endif; ?>
            </form>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">
                                <?php echo e(($projects->currentPage() - 1) * $projects->perPage() + $index + 1); ?>

                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <?php if($project->featured_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $project->featured_image)); ?>" alt="<?php echo e($project->title); ?>" class="w-16 h-16 object-cover rounded-lg mr-3">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="text-sm font-medium text-slate-900 max-w-xs truncate"><?php echo e($project->title); ?></div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span class="<?php echo e($project->category_badge_color); ?> px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="<?php echo e($project->status_badge_color); ?> px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="<?php echo e(route('projects.show', $project->slug)); ?>" target="_blank" class="text-slate-600 hover:text-slate-900 mr-3 transition" title="View">
                                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
                                </a>
                                <button onclick="adminProjectEditProject(<?php echo e($project->id); ?>)" class="text-blue-600 hover:text-blue-900 mr-3 transition" title="Edit">
                                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                                <button onclick="adminProjectDeleteProject(<?php echo e($project->id); ?>)" class="text-red-600 hover:text-red-900 transition" title="Delete">
                                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white px-6 py-4 border-t border-slate-200">
                ...
                <?php echo e($projects->withQueryString()->links('pagination.custom')); ?>
...
<div class="md:col-span-2">
    ...
    <div id="galleryPreviewEdit" class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 mb-3">
        <?php if(isset($project) && $project->gallery_images): ?>
            <?php $__currentLoopData = $project->gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative group">
                    <img src="<?php echo e(asset('storage/' . $image)); ?>" class="w-full h-20 object-cover rounded-lg border border-slate-200">
<button type="button" 
        onclick="removeExistingGalleryImage(this, '<?php echo e($image); ?>', <?php echo e($project->id ?? 'null'); ?>)" 
...
<script>
    ...
    document.getElementById('addProjectForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.projects.store")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.adminmain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\indo_drilling_school\resources\views/admin/projects/index.blade.php ENDPATH**/ ?>