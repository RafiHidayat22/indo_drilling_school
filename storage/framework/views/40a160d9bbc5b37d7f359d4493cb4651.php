    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-slate-900 max-w-xs truncate"><?php echo e($article->title ?? $article['title']); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e('category-badge-' . strtolower($article->category ?? $article['category'])); ?>">
                                    <?php echo e($article->category ?? $article['category']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo e($article->author ?? $article['author']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        <?php if(($article->status ?? $article['status']) === 'Published'): ?> bg-green-100 text-green-800
                                        <?php else: ?> bg-amber-100 text-amber-800 <?php endif; ?>">
                                    <?php echo e($article->status ?? $article['status']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">
                                <?php echo e(($article->created_at ?? $article['date'])); ?>
            ...
            <div class="bg-white px-6 py-4 border-t border-slate-200">
                <?php if(isset($articles) && $articles->isNotEmpty()): ?>
