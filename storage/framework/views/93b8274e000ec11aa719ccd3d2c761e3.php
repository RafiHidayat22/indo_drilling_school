    ...
    <section class="pd-courses-section">
        <div class="pd-container">
            ...
            <div class="pd-courses-list">
                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyName => $trainings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pd-course-item" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="pd-item-header" onclick="toggleCompany(<?php echo e($loop->index); ?>)">
                        <div class="pd-item-title-wrapper">
                            ...
                            <div>
                                <h3 class="pd-item-title"><?php echo e($companyName); ?></h3>
                                <p class="pd-item-subtitle"><?php echo e(count($trainings)); ?> training<?php echo e(count($trainings) > 1 ? 's' : ''); ?> available</p>
                            </div>
                        </div>
                    </div>
                    
                    <div class="pd-item-content" id="company-content-<?php echo e($loop->index); ?>">
                            ...
                            <div class="pd-detail-section">
                                <div class="pd-company-trainings">
                                    ...
                                    <div class="pd-training-item">
                                        ...
                                        <a href="/programs/<?php echo e($programSlug); ?>/enroll/<?php echo e($training['slug']); ?>" class="pd-enroll-button">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\indo_drilling_school\resources\views/programDetail.blade.php ENDPATH**/ ?>