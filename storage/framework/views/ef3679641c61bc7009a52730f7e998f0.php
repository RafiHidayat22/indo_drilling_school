<aside class="fixed left-0 top-0 w-64 h-screen overflow-y-auto z-40 bg-slate-800 shadow-xl">
    ...
    <nav class="px-4 py-6">
        ...
        <div>
            ...
            <a href="#"
                class="sidebar-menu-item flex items-center px-4 py-3 
                      <?php echo e(request()->is('pengaturan*') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:text-white hover:bg-slate-700'); ?> 
                      rounded-lg">
                <div class="sidebar-icon">
            ...
            <a href="#"
                class="sidebar-menu-item flex items-center px-4 py-3 
                      <?php echo e(request()->is('laporan*') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:text-white hover:bg-slate-700'); ?> 
                      rounded-lg">
                <div class="sidebar-icon">
