...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div id="categoriesAddModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
        <div class="bg-white rounded-2xl shadow-2xl max-w-3xl w-full my-8 transform transition-all max-h-[90vh] flex flex-col">
            ...
            <form class="p-6 space-y-6 overflow-y-auto flex-1" method="POST" action="<?php echo e(route('categories.store')); ?>">
                <?php echo csrf_field(); ?>
                <!-- Nama Kategori -->
                <div>
    ...
    <!-- Modal Edit Kategori -->
    <div id="categoriesEditModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
        <div class="bg-white rounded-2xl shadow-2xl max-w-3xl w-full my-8 transform transition-all max-h-[90vh] flex flex-col">
            ...
            <form id="categoriesEditForm" class="p-6 space-y-6 overflow-y-auto flex-1" method="POST" action="<?php echo e(route('categories.update', ':id')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div id="categoriesDeleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
...
(function() {
    ...
    const categoriesIconLibrary = {
        'safety': '<svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>',
    ...
    // Fungsi universal untuk render icon selection - PERBAIKAN DI SINI
    function categoriesRenderIconSelection(containerId, selectedKey, colorScheme) {
        ...
        const hiddenInputId = (containerId === 'iconSelection' || containerId === 'categoriesIconSelection') 
    ...
    window.categoriesOpenAddModal = function() {
        ...
        // PERBAIKAN: Render langsung tanpa timeout
        requestAnimationFrame(() => {
            categoriesRenderIconSelection('iconSelection', null, 'indigo');
        });
    };
    ...
    window.categoriesOpenEditModal = function(data) {
        ...
        // PERBAIKAN: Render langsung dengan requestAnimationFrame
        requestAnimationFrame(() => {
    ...
    window.categoriesOpenDeleteModal = function(data) {
        ...
        if (document.getElementById('categoriesDeleteId'))
            document.getElementById('categoriesDeleteId').value = data.id || '';
        if (document.getElementById('categoriesDeleteCategoryName'))
            document.getElementById('categoriesDeleteCategoryName').textContent = data.title || data.name || 'ini';
    ...
    function categoriesInit() {
        ...
        document.querySelectorAll('[id^="categories"][id$="Modal"]').forEach(modal => {
...
<?php echo $__env->make('layouts.adminmain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\indo_drilling_school\resources\views/categories.blade.php ENDPATH**/ ?>