...
<div class="page-home">
    ...
    <section id="programs" class="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="relative">
                ...
                <!-- Navigation Dots - Hanya Tampil di Desktop -->
                <div class="hidden md:flex justify-center gap-2 mt-8" id="programsDots"></div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="relative">
                <div class="overflow-x-auto overflow-y-hidden home-animate-fadeInUp delay-200 home-scrollbar-hide pb-4" id="insightsContainer" style="scroll-behavior: smooth;">
                    <div class="flex gap-6 w-max" id="insightsScroll">
                        ...
                        <div class="flex-shrink-0 w-80">
                            <div class="group bg-white border border-gray-200 rounded-3xl overflow-hidden text-left hover:shadow-2xl hover:border-blue-200 transition-all duration-500 transform hover:-translate-y-2 flex flex-col h-full">
                                ...
                                <div class="p-6 flex flex-col flex-grow"> <!-- padding disesuaikan agar proporsional -->
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 leading-tight min-h-[3.5rem] line-clamp-2">
                                        <?php echo e($article->title); ?>

                                    </h3>
                                    <p class="text-gray-600 mb-4 leading-relaxed flex-grow min-h-[5rem] line-clamp-3">
                                    ...
                                    <a href="<?php echo e(route('articles.show', $article->slug)); ?>"
                                        class="inline-flex items-center gap-1.5 text-blue-700 font-semibold hover:gap-2 transition-all group mt-auto">
                                        Read More
                ...
                <!-- Navigation Dots - Hidden on mobile, centered on desktop -->
                <div class="hidden md:flex justify-center gap-2 mt-8" id="insightsDots"></div>
            </div>
        ...
        (function() {
            ...
            if (window.matchMedia('(min-width: 768px)').matches) {
                ...
                function updateDots() {
                    ...
                    dots.forEach((dot, index) => {
                        dot.className = index === currentIndex ?
                            'w-8 h-2 rounded-full bg-red-600 transition-all duration-300' :
                ...
                document.addEventListener('visibilitychange', () => {
                    ...
                    else if (!isHovering) startAutoScroll();
                });

                // Re-init dots on resize (desktop only)
                const handleResize = () => {
                    if (window.matchMedia('(min-width: 768px)').matches && dotsContainer.children.length === 0) {
                ...
                // Mobile: sembunyikan dots
                if (dotsContainer) dotsContainer.style.display = 'none';
            }
        })();


        // =============== INSIGHTS AUTO-SCROLL + DOTS ===============
        (function() {
            const container = document.getElementById('insightsContainer');
            const scrollContent = document.getElementById('insightsScroll');
            ...
            if (window.matchMedia('(min-width: 768px)').matches) {
                ...
                for (let i = 0; i < cardCount; i++) {
                    const dot = document.createElement('button');
                    dot.className = `w-2 h-2 rounded-full transition-all duration-300 ${i === 0 ? 'bg-blue-600 w-8' : 'bg-gray-300'}`;
                ...
                function startAutoScroll() {
                    stopAutoScroll();
                    autoScrollInterval = setInterval(autoScroll, 4000); // sedikit lebih lambat
                }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\indo_drilling_school\resources\views/home.blade.php ENDPATH**/ ?>