...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['active']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['featured']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-amber-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['years']->count()); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-4 mb-6">
            <form method="GET" action="<?php echo e(route('galleryadmin.index')); ?>" class="flex flex-wrap items-center gap-4">
                <div class="flex-1 min-w-[250px]">
                    <div class="relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari gambar..." class="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                ...
                <select name="year" class="px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $stats['years']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(request()->hasAny(['search', 'year', 'status'])): ?>
                <a href="<?php echo e(route('galleryadmin.index')); ?>" class="px-4 py-2.5 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition text-sm font-medium">
                    Reset
                </a>
                <?php endif; ?>
            </form>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden p-6">
            ...
            <div id="galleryGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="gallery-item group relative bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                    ...
                    data-order="<?php echo e($image->order); ?>">
                    <!-- Image Container -->
                    <div class="relative h-48 overflow-hidden bg-slate-100">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                <p class="text-white text-sm line-clamp-2"><?php echo e($image->description); ?></p>
                            </div>
                        </div>
                    ...
                    <!-- Content -->
                    <div class="p-4">
                        <h3 class="text-base font-semibold text-slate-800 mb-2 line-clamp-2"><?php echo e($image->title); ?></h3>

                        <!-- Action Buttons -->
                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
                            <div class="flex gap-2">
                                <button onclick="galleryAdmin_viewImage(<?php echo e($image->id); ?>)"
                                ...
                                <button onclick="galleryAdmin_editImage(<?php echo e($image->id); ?>)"
                                ...
                                <button onclick="galleryAdmin_deleteImage(<?php echo e($image->id); ?>)"
                            ...
                            <div class="flex items-center gap-1">
                                <!-- Toggle Active -->
                                <button onclick="galleryAdmin_toggleActive(<?php echo e($image->id); ?>)"
                                    class="p-2 <?php echo e($image->is_active ? 'text-green-600 bg-green-50' : 'text-slate-400 hover:text-green-600 hover:bg-green-50'); ?> rounded-lg transition"
                                    title="Toggle Active">
                                    <svg class="w-5 h-5" fill="<?php echo e($image->is_active ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </button>
                                <!-- Toggle Featured -->
                                <button onclick="galleryAdmin_toggleFeatured(<?php echo e($image->id); ?>)"
                                    class="p-2 <?php echo e($image->is_featured ? 'text-red-600 bg-red-50' : 'text-slate-400 hover:text-red-600 hover:bg-red-50'); ?> rounded-lg transition"
                                    title="Toggle Featured">
                                    <svg class="w-5 h-5" fill="<?php echo e($image->is_featured ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                    </svg>
                                </button>
                            </div>
            ...
            <div class="mt-8">
                ...
                <?php echo e($images->withQueryString()->links('pagination.custom')); ?>
        ...
        <form id="addImageForm" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="year" id="addYear" min="2000" max="<?php echo e(date('Y') + 5); ?>" value="<?php echo e(date('Y')); ?>" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" required>
                </div>
                <!-- Order -->
                <div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form id="editImageForm" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Tahun *</label>
                    <input type="number" name="year" id="editYear" min="2000" max="<?php echo e(date('Y') + 5); ?>" value="<?php echo e(date('Y')); ?>" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" required>
                </div>
                <!-- Order -->
                <div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Sortable(galleryGrid, {
            ...
            onEnd: async function(evt) {
                ...
                // Kirim ke server
                try {
                    const res = await fetch('<?php echo e(route("galleryadmin.reorder")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.adminmain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\indo_drilling_school\resources\views/gallery/index.blade.php ENDPATH**/ ?>