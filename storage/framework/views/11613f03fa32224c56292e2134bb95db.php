                ...
                <div class="md:col-span-2">
                    ...
                    <div id="galleryPreviewEdit" class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 mb-3">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button"
                                onclick="removeExistingGalleryImage(this, '<?php echo e($image); ?>')"
...
<?php echo $__env->make('layouts.adminmain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\indo_drilling_school\resources\views/admin/projects/index.blade.php ENDPATH**/ ?>