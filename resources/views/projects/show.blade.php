...
@section('title', $project->title . ' | Indonesia Drilling School')
            ...
            <div class="flex flex-col justify-center min-h-[70vh] py-20">
                ...
                <div class="max-w-4xl">
                    ...
                    <div class="flex flex-wrap gap-3 mb-6">
                        <span class="{{ $project->status_badge_color }} px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm">
                        ...
                        <div class="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pb-4 border-b border-gray-200">
                                    ...
                                    <p class="font-semibold text-gray-900">{{ $project->location }}</p>
                                </div>
                                @endif

                                <div class="pb-4 border-b border-gray-200">
                                    <p class="text-sm text-gray-500 mb-1">Status</p>
                                    <span class="{{ $project->status_badge_color }} px-3 py-1.5 rounded-full text-sm font-semibold">
                                        {{ ucfirst($project->status) }}
                                    </span>
                                </div>
