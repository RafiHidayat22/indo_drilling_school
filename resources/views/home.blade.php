...
<section class="relative h-screen bg-gray-900 text-white overflow-hidden pt-12 md:pt-0">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 flex flex-col md:flex-row h-full">
        <!-- Text -->
        <div class="md:w-1/2 flex flex-col justify-center text-center md:text-left animate-fadeInUp">
            ...
            <p class="text-gray-300 text-lg md:text-xl mb-8 animate-fadeInUp delay-200 leading-relaxed">
                Empowering Indonesia's Workforce for the Global Energy Industry
            </p>
            <div class="flex flex-col sm:flex-row justify-center md:justify-start gap-4 animate-fadeInUp delay-300">
        ...
        <div class="md:w-1/2 relative flex justify-center items-end mt-8 md:mt-0">
            ...
            <img src="{{ asset('images/EngineerHero.png') }}" 
                 alt="Engineer"
                 class="relative w-72 md:w-[400px] lg:w-[480px] drop-shadow-2xl z-10 md:absolute md:bottom-0 md:right-10 animate-float" />
        </div>
    </div>
...
<section class="py-20 px-6 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden" id="about">
  ...
  <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
    ...
    <div class="space-y-6">
      ...
      <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 text-left animate-fadeInUp leading-tight">
        About Indonesia Drilling School
      </h2>
      <p class="text-gray-600 text-lg mb-10 text-left animate-fadeInUp delay-200 leading-relaxed">
      ...
      @foreach ([
        ...
        ['Mission', '<ol class="list-disc ml-5 space-y-2"><li>Produce skilled and professional workers.</li><li>Provide the best services to society.</li><li>Design and develop competency-based curricula, education, and training programs that align with labor market needs.</li><li>Continuously enhance the competence and professionalism of internal human resources, including both educators and administrative staff.</li></ol>', 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
        ['Goals', '<ol class="list-disc ml-5 space-y-2"><li>Become a nationally recognized model educational institution.</li><li>Deliver the highest quality services to the community.</li><li>Conduct job-oriented skill training programs.</li><li>Achieve at least a 95% job placement rate for graduates.</li><li>Develop excellent, educated, competent, and professional workers, creating human resources with integrity and expertise in their respective fields.</li><li>Support government initiatives in human resource development.</li></ol>', 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z']
      ] as [$title, $content, $icon])
        <div class="group bg-white border border-gray-200 rounded-2xl p-6 text-left mb-4 animate-fadeInUp hover:shadow-xl hover:border-red-200 transition-all duration-300 hover:-translate-y-1">
    ...
    <!-- Right Image Section -->
    <div class="flex justify-center animate-fadeInUp delay-500">
...
<section id="programs" class="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6 animate-fadeInUp">Our Training Programs</h2>
        ...
        <div class="relative">
            <div class="overflow-x-auto overflow-y-hidden animate-fadeInUp delay-200 scrollbar-hide pb-4" id="programsContainer" style="scroll-behavior: smooth;">
...
<section class="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6 animate-fadeInUp">
        ...
        <div class="swiper insightSwiper animate-fadeInUp delay-200">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="mb-16">
            ...
            <div class="overflow-hidden">
                <div class="flex items-center gap-8 animate-scroll-left">
                    @php
                        $internationalLogos = [
        ...
        <div>
            ...
            <div class="overflow-hidden">
                <div class="flex items-center gap-8 animate-scroll-right">
                    @php
                        $nationalLogos = [
